...
function ScoutNet() {
  ...
  this.getButton = document.getElementById('get');
...
ScoutNet.prototype.loadTeams = function() {
  ...
  this.teamsRef.limitToLast(12).on('child_added', addTeam);
  this.teamsRef.limitToLast(12).on('child_changed', addTeam);
};

// Saves a new message on the Firebase DB.
ScoutNet.prototype.saveTeam = function(e) {
  e.preventDefault();
